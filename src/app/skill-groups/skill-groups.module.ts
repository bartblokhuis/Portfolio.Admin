...
@NgModule({
  declarations: [CreateSkillGroupComponent, DeleteSkillGroupComponent, ListSkillGroupComponent, CreateSkillComponent, EditSkillComponent, DeleteSkillComponent, ListSkillComponent],
  imports: [
    CommonModule,
